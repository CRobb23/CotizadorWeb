...
public abstract class AbstractBusServiceImpl {
    ...
    protected String toSOAP(Object soapObj) throws ConvertException {
        try {
            String soapMessage =  XMLMarshalUtil.toXML(soapObj.getClass(), soapObj);
            return soapMessage;
    ...
    protected String toJSON(Object restObj) throws ConvertException {
        try {
            String restMessage = JSONMarshalUtil.toJSON(restObj);
            return restMessage;
        } catch (JSONMarshalException e) {
            log.error(e.getMessage(), e);
            throw new ConvertException("PROBLEMA DE CONVERSION SOAP/JSON", e);
        }
    }

    protected Object fromJSON(String restMessage, Class restClass) throws ConvertException {
        try {
            return JSONMarshalUtil.fromJSON(restClass, restMessage);
        } catch (JSONMarshalException e) {
            log.error(e.getMessage(), e);
            throw new ConvertException("PROBLEMA DE CONVERSION JSON/CSV", e);
        }
    ...
    protected Object fromSOAP(String soapMessage, Class soapClass) throws ConvertException {
        try {
            return XMLMarshalUtil.fromXML(soapClass, soapMessage);
        } catch (XMLMarshalException  e) {
            log.error(e.getMessage(), e);
            throw new ConvertException("PROBLEMA DE CONVERSION SOAP/JSON", e);
        }
