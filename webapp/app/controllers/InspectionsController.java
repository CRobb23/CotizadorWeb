...
public class InspectionsController extends Controller {
	...
	public static void finishAutoInspection(String body) {
		InspectionAutoResponse inspectionAutoResponse = inspectionService.finishAutoInspection(body);
		renderJSON(inspectionAutoResponse);
	}
