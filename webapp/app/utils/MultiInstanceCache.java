...
public class MultiInstanceCache {
    ...
    /**
     * HEAD de la lista encadenada de reutilización de {@link InstanceHolder}.
     */
    protected InstanceHolder head;

    /**
     * TAIL de la lista encadenada de reutilización de {@link InstanceHolder}.
     */
    ...
    /**
     * Cantidad de {@link InstanceHolder} que pueden ser reutilizados.
     */
    ...
    /**
     * Subclase de {@link Comparator} que será utilizada para ordenar los elementos.
     */
    ...
    /**
     * Agrega una instancia de {@link InstanceHolder} a la lista encadenada para ser reutilizados posteriormente
     * minimizando la creación de objetos.
     * @param holder la instancia de {@link InstanceHolder} a la lista encadenada para ser reutilizados posteriormente.
     */
    ...
    /**
     * Remueve una instancia de {@link InstanceHolder} de la lista de objetos reutilizables y si no hay ningún elemento crea uno
     * nuevo y le asigna como valor el parámetro <code>value</code>.
     * @param value el objeto que debe estar contenido dentro del objeto {@link InstanceHolder}.
     * @return una instancia reutilizada o nueva de {@link InstanceHolder} que contiene como valor <code>value</code>.
     */
    ...
    protected static class CacheCleaningThread extends Thread {
         ...
         */
        protected final MultiInstanceCache cache;
        ...
        /**
         * Inicializa un {@link CacheCleaningThread} que verificará la estructura especificada por <code>cache</code> cada <code>cleaningInterval</code>
         * segundos.
