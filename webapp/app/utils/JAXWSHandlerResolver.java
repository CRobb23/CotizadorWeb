...
/**
 * Subclase de {@link HandlerResolver} que devuelve en el método {@link #getHandlerChain(PortInfo)} un objeto {@link List} con un elemento
...
public class JAXWSHandlerResolver implements HandlerResolver {
	...
	/**
	 * Singleton de {@link JAXWSHandlerResolver}.
	 */
...
//	protected ExtractSoapPayloadHandler xmlHandler;
	...
	/**
	 * Objeto {@link List} conteniendo solamente una instancia de {@link ExtractSoapPayloadHandler}.
	 */
	...
	/**
	 * Inicializa un {@link JAXWSHandlerResolver} y crea la información que será utilizada como handler chain.
	 */
...
//	}
	...
	/**
	 * Le especifica a este {@link JAXWSHandlerResolver} que su instancia de {@link ExtractSoapPayloadHandler} no debe procesar los mensajes
	 * de respuesta enviados por los servicios de la entidad financiera.
	 * @param shouldProcessIncomingMessages especifica a este {@link JAXWSHandlerResolver} que su instancia de {@link ExtractSoapPayloadHandler} no debe procesar los mensajes
	 * de respuesta enviados por los servicios de la entidad financiera.
	 */
	 ...
	 * @param shouldProcessOutgoingMessages especifica a este {@link JAXWSHandlerResolver} que su instancia de {@link ExtractSoapPayloadHandler} no debe procesar los mensajes
	 * de enviados a los servicios de la entidad financiera.
	 */
