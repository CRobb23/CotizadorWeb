...
/**
 * Implementación de {@link SOAPHandler} utilizada para obtener los requests y response de clientes JAX-WS generados y de esta forma 
...
public class ExtractSoapEnvelopeHandler implements SOAPHandler< SOAPMessageContext > {
	...
	/**
	 * Inicializa un {@link ExtractSoapEnvelopeHandler}
	 */
	 ...
	 * 
	 * @param context el objeto {@link SOAPMessageContext} que contiene la información del mensaje recibido.
	 * @return true.
	 */
