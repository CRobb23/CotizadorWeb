...
/**
 * Implementación de {@link LogicalHandler} utilizada para obtener los requests y response de clientes JAX-WS generados y de esta forma 
...
public class ExtractSoapPayloadHandler implements LogicalHandler< LogicalMessageContext > {
	...
	/**
	 * Inicializa un {@link ExtractSoapPayloadHandler} y crea el {@link Transformer} para no crearlo al momento
...
//		factory.setAttribute("indent-number", 4);
			...
			try {
				...
				transformer.setOutputProperty( OutputKeys.METHOD, "webservices" );
	 ...
	 * 
	 * @param context el objeto {@link LogicalMessageContext} que contiene la información del mensaje recibido.
	 * @return true.
	 */
