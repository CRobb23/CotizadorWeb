...
public class ServiceBusWebConfig extends WsConfigurerAdapter {
    ...
    public XsdSchema repairSchema() {
        return new SimpleXsdSchema(new ClassPathResource("incoming/autoInspectionUpdate.xsd"));
    }
}
